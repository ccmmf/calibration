...
calibration establishes about the model. It is a site-level calibration, not a final
parameter set for the statewide inventory.
...
The report refers to the eight cropping systems by number throughout. System 1 is the
unamended control, system 2 receives compost, and systems 3 to 8 receive compost with
cover crops.
...
|---|---|---|---|---|---|
| calibration | Salinas | organic vegetables, eight systems | soil carbon stock, 0-30 cm | 2005-2011 | compost and cover crops against an unamended control |
...
Salinas soil carbon is therefore contracted to eight quantities: the unamended control as
...
| quantity | value (Mg C ha⁻¹) | SE |
|---|---:|---:|
| baseline stock, system 1, unamended control | 23.46 | 1.19 |
| compost, system 2 | +9.46 | 0.99 |
| compost with cover crops, system 3 | +10.79 | 1.11 |
| compost with cover crops, system 4 | +12.57 | 1.34 |
| compost with cover crops, system 5 | +11.86 | 1.28 |
| compost with cover crops, system 6 | +12.18 | 1.59 |
| compost with cover crops, system 7 | +11.68 | 1.62 |
| compost with cover crops, system 8 | +12.54 | 1.44 |
...
|---|---:|---:|---:|---:|---:|---:|
| system 1, unamended control | 23.46 | 1.19 | 12.91 | 23.76 | −8.85 | +0.25 |
...
standard errors falls from 4.80 to 1.50. The unamended control is recovered to within a
...
### Performance against reporting criteria

Soil carbon offset reporting protocols evaluate a calibrated model on prediction interval
coverage and on mean bias relative to measurement uncertainty. The DayCent-CR validation
reports coverage of at least 90 percent for 90 percent prediction intervals, with mean
bias below pooled measurement uncertainty (Mathers et al., 2023). Evaluated the same way,
this calibration does not yet meet those criteria.
...
Coverage before calibration reflects a prior wide enough to contain any outcome rather
than a model that predicts well. After calibration the ensemble is narrow and biased high:
mean bias exceeds pooled measurement uncertainty, and five of eight observations fall
outside the prediction interval. The cause is the one-signed residual described below,
which no choice of these three parameters removes.
...
Mathers, C., Black, C. K., Segal, B. D., et al. (2023). Validating DayCent-CR for cropland
soil carbon offset reporting at a national scale. *Geoderma*, 438, 116647.
https://doi.org/10.1016/j.geoderma.2023.116647
